...
public class DocumentController {
    ...
    public ResponseEntity<?> deleteDocument(
        ...
        try {
            LogUtils.logBusiness("DELETE_DOCUMENT", userId, "接收到删除文档请求: fileMd5=%s, ownerUserId=%s", fileMd5, ownerUserId);
            
            Optional<FileUpload> fileOpt = fileUploadRepository.findFirstByFileMd5AndUserIdOrderByCreatedAtDesc(fileMd5, ownerUserId);
            if (fileOpt.isEmpty()) {
            ...
            documentService.deleteDocument(fileMd5, ownerUserId, userId);
            ...
            LogUtils.logBusinessError("DELETE_DOCUMENT", userId, "删除文档失败: fileMd5=%s, ownerUserId=%s", e, fileMd5, ownerUserId);
    ...
    public ResponseEntity<?> downloadFileByName(
        ...
        try {
            ...
            if (userId == null) {
                ...
                String downloadUrl = documentService.generateDownloadUrl(file.getFileMd5(), file.getFileName());
    ...
    private Map<String, Object> buildPreviewResponse(FileUpload file, Integer pageNumber, boolean preferSinglePagePreview) {
        ...
        String previewUrl = documentService.generatePreviewUrl(file.getFileMd5(), file.getFileName());
        if (previewUrl == null) {
            return null;
        }
