...
import com.canggo.zhishu.service.RechargeService;
import com.canggo.zhishu.service.WxPayService;
...
public class RechargeController {
    ...
    public ResponseEntity<?> getPackages() {
        try {
            List<com.canggo.zhishu.model.RechargePackage> packages = rechargeService.getAllPackages();
