...
import com.canggo.zhishu.model.RechargeOrder;
import com.canggo.zhishu.model.RechargeOrder.OrderStatus;
import com.canggo.zhishu.model.RechargePackage;
import com.canggo.zhishu.repository.RechargeOrderRepository;
import com.canggo.zhishu.repository.RechargePackageRepository;
import com.canggo.zhishu.utils.PriceUtil;
...
public class RechargeService {
    ...
    public WxPayService.PrePayInfoResBo createRechargeOrder(
        ...
        if (packageId != null && packageId > 0) {
            ...
            description = "【智枢】充值套餐：" + rechargePackage.getPackageName();
        } else {
            // 自定义充值
            ...
            description = "【智枢】自定义充值￥" + PriceUtil.toYuanPrice(amount) + "元";
        }
