package com.canggo.zhishu.utils;
...
public class LogUtils {
    ...
    // 业务日志记录器
    private static final Logger BUSINESS_LOGGER = LoggerFactory.getLogger("com.canggo.zhishu.business");
    
    // 性能日志记录器
    private static final Logger PERFORMANCE_LOGGER = LoggerFactory.getLogger("com.canggo.zhishu.performance");
